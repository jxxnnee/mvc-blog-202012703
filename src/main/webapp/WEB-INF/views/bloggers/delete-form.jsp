        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <input type="hidden" name="_method" value="delete"/>
            	<h3> 정말로 삭제하시겠습니까? </h3>
              <button class="btn btn-lg btn-google btn-block text-uppercase" type="submit">Yes</button>
              <a class="btn btn-lg btn-primary btn-block text-uppercase" href="javascript:history.back()">No</a>
              <hr class="my-4">
             </form>
          </div>
        </div>
